...
class ColorCorrectionDirectionActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_color_correction_direction)
        ...
        buttonStart.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                val intent = Intent(this, MenuColorCorrectionActivity::class.java)
